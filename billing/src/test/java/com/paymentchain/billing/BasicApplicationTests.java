...
/*
 * allow test only http incoming request layer without start the server, spring
 * boot instatiates only the InvoiceRestController rather than the whole context
 */
...
public class BasicApplicationTests {
    ...
    public void testCreate() throws Exception {
        ...
        this.mockMvc
                .perform(post("/billing").header("Authorization", "Basic " + encoding)
                        .contentType(MediaType.APPLICATION_JSON).content(asJsonString(mockdto)))
    ...
    public void testFindById() throws Exception {
        ...
        this.mockMvc
                .perform(get("/billing/{id}", mockdto.getId()).header("Authorization", "Basic " + encoding)
